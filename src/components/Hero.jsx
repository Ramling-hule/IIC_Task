...
const Hero = () => {
  ...
  return (
    <section id="hero" ref={container} className="min-h-screen flex items-center relative overflow-hidden pt-28 pb-12 md:pt-0 md:pb-0 bg-black">
      ...
      <div className="absolute inset-0 bg-gradient-to-b md:bg-gradient-to-r from-black via-black/90 to-black/60 z-0"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="hero-content text-center md:text-left">
          ...
          <div className="animate-text">
            <p className="font-code text-green-400 text-xs md:text-sm mb-4 tracking-widest border border-green-500/30 inline-block px-3 py-1 rounded bg-black/50 backdrop-blur-sm">
              &lt; SYSTEM_ONLINE /&gt;
            </p>
          </div>
          ...
          <p className="animate-text font-code text-gray-300 text-sm md:text-lg max-w-lg mx-auto md:mx-0 mb-8 leading-relaxed">
            // JOIN_THE_REVOLUTION <br/>
            Innovate. Debug. Deploy. The biggest coding saga begins here.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button className="animate-btn font-cyber px-8 py-3 md:py-4 bg-green-600 hover:bg-green-500 text-black font-bold clip-path-polygon transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(34,197,94,0.6)]">
              INITIALIZE_REGISTER()
            </button>
            <button className="animate-btn font-cyber px-8 py-3 md:py-4 border border-zinc-600 hover:border-white hover:bg-white/5 text-white font-bold transition-all">
              VIEW_DOCS
            </button>
          </div>
        </div>

        <div className="flex justify-center md:justify-end perspective-1000 mt-4 md:mt-0">
          <CodeWindow />
        </div>
