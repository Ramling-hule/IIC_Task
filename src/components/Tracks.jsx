...
const Tracks = () => {
  ...
  const tracks = [
    { 
      title: "AI & Automation", 
      desc: "Build the autonomous agents of tomorrow.", 
      icon: (
    ...
    { 
      title: "Blockchain", 
      desc: "Decentralize the future with Web3 logic.", 
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { 
      ...
      desc: "Defend the digital frontier from threats.", 
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { 
      ...
      desc: "Solve real-world problems with code.", 
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section id="tracks" ref={container} className="min-h-screen py-24 bg-black text-white px-6 relative z-10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <h2 className="font-cyber text-4xl md:text-5xl font-bold mb-20 text-center uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600 drop-shadow-[0_0_15px_rgba(34,197,94,0.3)]">
          // Event Tracks
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 perspective-1000">
          {tracks.map((track, i) => (
            <div key={i} className="track-card relative p-8 border border-zinc-800 bg-zinc-900/40 backdrop-blur-sm hover:border-green-500/50 hover:bg-zinc-900/80 transition-all duration-500 group cursor-pointer rounded-xl overflow-hidden hover:-translate-y-2">
              ...
              <div className="flex justify-between items-center border-t border-zinc-800 pt-4 mt-auto group-hover:border-green-500/30 transition-colors">
